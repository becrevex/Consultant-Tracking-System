...
//
// DESCRIPTION
//  Document class to describe the attributes of a document record
//
...
public class Document {
    private IntegerProperty documentId;
    ...
    public Document() {
        documentId      = new SimpleIntegerProperty();
    ...
    public Document(int documentId, int assignmentId, String type, String fileName, 
...
//Property Getters
    ...
    public IntegerProperty getDocumentIdProperty() {
    ...
    public static String validateDocument(String selectedFileName,
                                               String documentType,
